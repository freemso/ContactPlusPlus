...
This project uses [electron-react-boilerplate](https://github.com/electron-react-boilerplate/electron-react-boilerplate/tree/master).
...
```bash
git clone --branch master https://github.com/freemso/ContactPlusPlus.git your-project-name
```
